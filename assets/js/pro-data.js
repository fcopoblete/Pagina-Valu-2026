...
window.proDataExtended = {
    "valentina-jimenez": {
        nombre: "Valentina Jiménez",
        cargo: "Psicóloga / Directora",
        img: "assets/img/team/valentina-jimenez.webp?v=top_framed",
        bg: "bg-brand-lila/20",
    ...
    "erik-navarro": {
        nombre: "Erik Navarro",
        cargo: "Psicólogo",
        img: "assets/img/team/erik-navarro.webp?v=top_framed",
    ...
    "eva-aguayo": {
        nombre: "Eva Aguayo",
        cargo: "Psicóloga",
        img: "assets/img/team/eva-aguayo.webp?v=top_framed",
        bg: "bg-brand-lila/20",
        especialidad: "Psicología",
        formacion: [
    ...
    "josefa-arias": {
        nombre: "Josefa Arias",
        cargo: "Psicóloga",
        img: "assets/img/team/josefa-arias.webp?v=top_framed",
    ...
    "valentina-gonzalez": {
        ...
        cargo: "Psicóloga",
        img: "assets/img/team/valentina-gonzalez.webp?v=top_framed",
        bg: "bg-brand-rosa/20",
        especialidad: "Psicología",
        formacion: [
    ...
    "cristopher-espejo": {
        ...
        cargo: "Psicólogo",
        img: "assets/img/team/cristopher-espejo.webp?v=top_framed",
        bg: "bg-primary-100/20",
        especialidad: "Psicología",
        formacion: [
    ...
    "maria-munoz": {
        nombre: "María Muñoz",
        cargo: "Psicóloga",
        img: "assets/img/team/maria-muñoz.webp?v=top_framed",
        bg: "bg-brand-beige/40",
        especialidad: "Psicología",
        formacion: [
    ...
    "bruno-araya": {
        nombre: "Bruno Araya",
        cargo: "Fonoaudiólogo",
        img: "assets/img/team/bruno-araya.webp?v=top_framed",
        bg: "bg-brand-lila/20",
        especialidad: "Fonoaudiología",
        formacion: [
